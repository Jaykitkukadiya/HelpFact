...
class extended_user_details(models.Model):
    ...
    mobile_number = models.CharField(max_length=100 , unique=True , null=True , blank=True)
...
class task_detail(models.Model):
    ...
    mobile_number = models.CharField(max_length=100, unique=False , blank=True , null=True)
